...
import { fetchAppSettings, fetchDeckPins, fetchRemotePosts, fetchRemoteProfiles } from '../lib/data/remote';
...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const [profiles, posts] = await Promise.all([fetchRemoteProfiles(), fetchRemotePosts(), fetchDeckPins(), fetchAppSettings()]);
