...
// 시진 — 한국 출생 기준 30분 보정(동경 135° 표준시 vs 한반도 127.5°). 점신·사주도령 등 국내 만세력과 같은 경계:
// 자시 23:30~01:30, 축시 01:30~03:30 … 진시 07:30~09:30
export const HOUR_RANGES = ['23:30–01:30', '01:30–03:30', '03:30–05:30', '05:30–07:30', '07:30–09:30', '09:30–11:30', '11:30–13:30', '13:30–15:30', '15:30–17:30', '17:30–19:30', '19:30–21:30', '21:30–23:30'] as const;
/** 시:분 → 시진 인덱스(0=자시). 30분 보정 적용: 07:13 → 묘시(3), 07:30 → 진시(4) */
export function hourBranchOf(hh: number, mm: number): number {
  const t = hh * 60 + mm - 30; // 보정 후 분
  return Math.floor((((t + 60) % 1440) + 1440) % 1440 / 120);
}
